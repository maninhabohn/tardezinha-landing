    ...
    <section className="bg-sdb-purple-dark px-6 py-20 text-white">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <div className="mt-10 inline-block rounded-3xl bg-white/10 p-8 backdrop-blur">
          ...
          {/* Diferencial: area coberta */}
          <div className="mt-6 inline-flex items-center gap-2 rounded-full bg-sdb-orange/20 px-5 py-2 text-sm font-semibold text-sdb-yellow ring-2 ring-sdb-orange/40">
            <span>☔</span>
