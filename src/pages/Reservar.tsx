...
export function Reservar() {
  useEffect(() => { document.title = 'Inscrição — Tardezinha Show de Bola' }, [])
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="mx-auto max-w-lg px-4 py-12 text-center">
          ...
          <div className="mt-10 rounded-2xl bg-white p-6 text-left shadow-md border border-gray-200">
            ...
            <p className="mb-1 text-gray-700">🎈 <strong>{selectedOption?.label}</strong> · Tardezinha Show de Bola</p>
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-amber-50 border-b border-amber-200 px-4 pt-6 pb-6 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-800 sm:text-3xl">Tardezinha Show de Bola 🎈</h1>
        ...
        <div className="mx-auto max-w-lg px-4 py-8 space-y-5">
          ...
          <div className="rounded-2xl border-2 border-sdb-purple bg-gradient-to-br from-sdb-purple/10 to-emerald-50 p-6 text-center">
            ...
            <a
              href={whatsappLink('Oi! Já sou cliente e quero confirmar minha presença na próxima Tardezinha. Pode me mandar o link?')}
        ...
        <div className="mx-auto max-w-md px-4 py-10">
          <div className="text-center mb-6">
            ...
            <p className="mt-2 text-gray-600">
              Confirma teu <strong>CPF</strong> pra abrir teu cadastro e garantir a vaga.
            </p>
          </div>
      ...
      <div className="bg-amber-50 border-b border-amber-200 px-4 pt-6 pb-6 text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-800 leading-tight sm:text-3xl">
          {retornante
            ...
            : <>Garante tua vaga na<br />Tardezinha 🎈</>}
        </h1>
        <p className="mt-2 text-base text-gray-600">
          {retornante
            ? 'Teu cadastro já tá aqui — é só conferir, marcar quem vai e confirmar.'
            : 'Uma tarde inteira + 4 horas de diversão. Tu descansa, a criançada brinca.'}
        </p>
