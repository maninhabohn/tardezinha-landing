...
export const EVENT_DATE_LABEL = '09/07/2026'
export const EVENT_DATE_LONG = '09 DE JULHO'
...
export const EVENT_THEME = 'Tema Junino 🌽'

// Prazo do valor antecipado (ISO, fuso BR -03:00)
export const ANTECIPADO_DEADLINE = '2026-07-07T23:59:59-03:00'
...
export const defaultWhatsappMessage = `Oi! Quero ingresso da Tardezinha Junina ${EVENT_DATE_LABEL}.`
